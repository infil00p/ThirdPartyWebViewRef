...
public class IceCreamCordovaWebViewClient extends ImpSpecificWebViewClient {

    private static final String TAG = "IceCreamCordovaWebViewClient";

    public IceCreamCordovaWebViewClient(CordovaInterface cordova, ReferenceWebView view) {
        super(cordova, view);
    }
