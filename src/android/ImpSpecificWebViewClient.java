 ...
 * @see CordovaWebView
 */
public class ImpSpecificWebViewClient extends WebViewClient {

    private static final String TAG = "AndroidWebViewClient";
    protected final CordovaInterface cordova;
    protected final ReferenceWebView appView;
    ...
    public ImpSpecificWebViewClient(CordovaInterface cordova, ReferenceWebView view) {
